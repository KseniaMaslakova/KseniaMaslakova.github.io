...
function Main() {
  SetMeans();
  Form      = new TForm();
  Form.Caption('FitМеню');
  Form.Width('879px');
  Form.Height('462px');
  Form.Top(screen.height/3 +"px");
//console.log(screen.height/2 + "px")
Form.Left('200px');
  //---
  Edit1   = new TEdit();
  Edit1.Top('432px');
  ...
  Panel3.Width('70px');
  Panel3.Height('22px');
  Panel3.Caption('ВуглеводніСтрави');
  Panel3.Border('none');
